...
//Pedro Cesar (https://github.com/PedroCesar553).
//28/03/2025
//Versão 0.1
...
let lancaPelaEsquerda = (Math.round(Math.random()) == 0)

let moduloLunar = {
    posicao: {
        x: lancaPelaEsquerda ? 100 : 700,
        y: 100
    },
    angulo: lancaPelaEsquerda ? -Math.PI / 2 : Math.PI / 2,
    largura: 20,
    altura: 20,
    cor: "lightgray",
    motorLigado: false,
    velocidade: {
        x: lancaPelaEsquerda ? 2 : -2,
        y: 0
    },
    combustivel: 1000,
